/*
    ...
    If decide to go drop the "whole" units, or find a different way to get to them, rename this layer "NaF"
...
Ergodox:
    ...
    |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
    |   Ø    |sPage |sPara |sLine |sWord | sDoc |------|           |------|      |   ^  |      |      |  F11 |    Ø   |
    |--------+------+------+------+------+------|   Ø  |           |  Ø   |------+------+------+------+------+--------|
    |   Ø    |mPage |mPara |mLine |mWord | mDoc |      |           |      |  <   |   v  |   >  |      |  F12 |    Ø   |
    `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
      |  Ø   |  Ø   |  Ø   |  Ø   |  Ø   |                                       |   Ø  |   Ø  | (NaF)|   Ø  |   Ø  |
      `----------------------------------'                                       `----------------------------------'
                                           ,-------------.       ,-------------.
                                           |   Ø  |   Ø  |       |  Ø   |  Ø   |
                                    ,------|------|------|       |------+------+------.
