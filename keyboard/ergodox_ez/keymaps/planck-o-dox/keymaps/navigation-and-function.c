/*
    ...
    Q: Should mirror the nav keys to flip over vertical axis?
...
Ergodox:
    ...
    |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
    |   Ø    |      | Home |  ^   | PgUp |      |   Ø  |           |  Ø   |      |  F7  |  F8  |  F9  |  F10 |    Ø   |
    |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
    |   Ø    |Ctl-A |  <   |  v   |  >   |Ctl-E |------|           |------|      |  F4  |  F5  |  F6  |  F11 |    Ø   |
    |--------+------+------+------+------+------|   Ø  |           |  Ø   |------+------+------+------+------+--------|
    |   Ø    |      | End  |  v   | PgDn |      |      |           |      |      |  F1  |  F2  |  F3  |  F12 |    Ø   |
    `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
      |  Ø   |  Ø   |  Ø   |  Ø   |  Ø   |                                       |   Ø  |   Ø  |   Ø  |   Ø  |   Ø  |
      `----------------------------------'                                       `----------------------------------'
                                           ,-------------.       ,-------------.
...
Planck:
    ...
    ,-----------------------------------------------------------------------.
    | Ø   |aWord|aLine|aPara|aPage|aDoc |     |     |     |     |     |   Ø |
    |-----------------------------------------------------------------------|
    | Ø   |sWord|sLine|sPara|sPage|sDoc |     |  ^  |     |     |     |   Ø |
    |-----------------------------------------------------------------------|
    | Ø   |mWord|mLine|mPara|mPage|mDoc |  <  |  v  |  >  |     |     |   Ø |
    |-----------------------------------------------------------------------|
    | Ø   |  Ø  |  Ø  |  Ø  |  Ø  |  Ø  |  Ø  |  Ø  |  Ø  |  Ø  |  Ø  |   Ø |
    `-----------------------------------------------------------------------'
...
[NAVIGATION_AND_FUNCTION_KEYMAP] = KEYMAP
    (
        // Left
...
//        // --------------------------------------------------------------------------------
//        KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,
//        KC_TRNS,    KC_NO,      KC_HOME,    KC_UP,      KC_PGUP,    KC_NO,      KC_TRNS,
//        KC_TRNS,    LCTL(KC_A), KC_LEFT,    KC_DOWN,    KC_RIGHT,   LCTL(KC_E),
//        KC_TRNS,    KC_NO,      KC_END,     KC_DOWN,    KC_PGDOWN,  KC_NO,      KC_TRNS,
//        // --------------------------------------------------------------------------------
//        KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,
//
//                                                                    KC_TRNS,    KC_TRNS,
...
//        // --------------------------------------------------------------------------------
//        KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,
//        KC_TRNS,    KC_NO,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_TRNS,
